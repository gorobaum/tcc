...
ocorre num PE. O processamento é iniciado atravez de \textit{comandos} que o \textit{host} manda para o \textit{device}.
Os PEs podem executar tanto no modelo de SIMD (Instrução Unica, Multiplos Dados) ou SPMD 
