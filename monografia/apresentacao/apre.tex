...
\frame{
  ...
  Toda a configuração para iniciar a transferência de dados entre o \textit{host} e o \textit{device} é feita pela primeira
  chamada a qualquer diretiva do CUDA. \\
  O modelo de plataforma do CUDA limita a um o número de devices ativos por vez. \\
